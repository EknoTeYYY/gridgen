  ...
  return (
    <div className="flex min-h-screen flex-col">
      <header className="fixed inset-x-0 top-4 z-50 px-4">
        <div className="mx-auto flex h-14 max-w-6xl items-center justify-between rounded-xl border border-border bg-background/30 px-4 shadow-lg shadow-black/5 backdrop-blur-xl transition-colors hover:bg-background/50 sm:px-6">
          ...
          <div className="mx-auto flex max-w-6xl flex-col gap-6 px-6 py-10 text-sm text-muted-foreground">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="font-heading font-medium text-foreground">Gridgen</span>
