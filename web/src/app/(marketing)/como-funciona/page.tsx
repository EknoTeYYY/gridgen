    ...
    <div className="relative overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6 pt-24 pb-20">
        <ScrollReveal type="fade-up" className="max-w-xl">
          <h1 className="font-heading text-4xl font-extrabold tracking-tight text-balance">Como funciona</h1>
        ...
        <div className="relative mt-20 hidden lg:grid lg:grid-cols-5 lg:gap-6">
          ...
          {PASSOS.map((passo, i) => (
            <ScrollReveal key={passo.numero} type="fade-up" delay={(i + 1) as 1 | 2 | 3 | 4 | 5}>
              <div className="relative z-10 flex flex-col items-center gap-3 text-center">
                ...
                <div className="flex flex-col gap-1.5">
                  <h2 className="font-heading text-base font-bold">{passo.titulo}</h2>
        ...
        <div className="mt-16 flex flex-col lg:hidden">
          {PASSOS.map((passo, i) => (
            <ScrollReveal key={passo.numero} type="fade-up" delay={(((i % 6) + 1)) as 1 | 2 | 3 | 4 | 5 | 6}>
              <div className="relative flex gap-6 pb-10 last:pb-0">
                ...
                <div className="flex flex-col gap-1.5 pt-2">
                  <span className="font-mono text-xs text-muted-foreground">{passo.numero}</span>
                  <h2 className="font-heading text-xl font-bold">{passo.titulo}</h2>
        ...
        <ScrollReveal type="fade-up" className="mt-16 flex flex-col items-start gap-4 border-t pt-12">
          <h2 className="font-heading text-2xl font-bold tracking-tight">O que acontece depois de aprovado</h2>
