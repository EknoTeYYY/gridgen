...
export const TIPOS: Record<TipoConteudo, ReceitaTipo> = {
  ...
  dor: {
    ...
    receita: ['photo', 'split', 'split', 'word', 'photo', 'photo'],
    temaInterno: 'ink',
  ...
  prova: {
    ...
    capa: { layout: 'photo', theme: 'ink', full: true },
    receita: ['photo', 'word', 'photo', 'split', 'split', 'photo'],
    temaInterno: 'ink',
  ...
  didatico: {
    ...
    receita: ['cover', 'item', 'item', 'item', 'item', 'photo'],
    temaInterno: 'ink',
  ...
  dado: {
    ...
    capa: { layout: 'photo', theme: 'ink', full: true },
    receita: ['photo', 'bottom', 'split', 'photo'],
    temaInterno: 'ink',
    ...
    nota: 'Post curto (4 slides). O dado é o conteúdo; o resto é moldura.',
  },
  oferta: {
