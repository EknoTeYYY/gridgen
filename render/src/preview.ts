...
const SLIDES: Slide[] = [
  { layout: 'word', theme: 'ink', headline: 'Isso aqui era só uma <em>ideia</em>.' },
  { layout: 'split', theme: 'ink', title: 'Passo um', text: 'Explicação curta do primeiro passo da sequência.' },
  {
    layout: 'list',
    theme: 'ink',
  ...
  { layout: 'word', theme: 'light', headline: 'Acento em <em>gradiente</em> — bug corrigido.' },
  ...
  { layout: 'split', theme: 'ink', variante: 0, title: 'Variante 0', text: 'Número ao lado, como sempre foi.' },
  { layout: 'split', theme: 'ink', variante: 1, title: 'Variante 1', text: 'Número empilhado acima do texto.' },
  { layout: 'split', theme: 'ink', variante: 2, title: 'Variante 2', text: 'Número gigante e apagado atrás do texto.' },
  { layout: 'split', theme: 'ink', variante: 3, title: 'Variante 3', text: 'Barra de destaque na lateral.' },
  { layout: 'word', theme: 'ink', variante: 0, headline: 'Texto <em>grande</em> de sempre.' },
  { layout: 'word', theme: 'ink', variante: 1, headline: 'Tudo <em>centralizado</em>.' },
  { layout: 'word', theme: 'ink', variante: 2, headline: 'Destaque <em>marcado</em>.' },
  { layout: 'word', theme: 'ink', variante: 3, headline: 'Ancorado à <em>direita</em>.' },
  { layout: 'item', theme: 'ink', variante: 0, title: 'Empilhado', text: 'A composição original, número acima do título.' },
  { layout: 'item', theme: 'ink', variante: 1, title: 'Badge circular', text: 'Número num círculo, ao lado do texto.' },
  { layout: 'item', theme: 'ink', variante: 2, title: 'Marca dágua', text: 'Número gigante e apagado atrás do título.' },
  { layout: 'item', theme: 'ink', variante: 3, title: 'Card destacado', text: 'Fundo levemente colorido ao redor do bloco.' },
  {
    layout: 'list',
    theme: 'ink',
    variante: 0,
  ...
  { layout: 'bottom', theme: 'ink', variante: 0, headline: 'Ancorado embaixo, como sempre.' },
  { layout: 'bottom', theme: 'ink', variante: 1, headline: 'Centralizado na tela.' },
  { layout: 'bottom', theme: 'ink', variante: 2, headline: 'Ancorado no topo.' },
  { layout: 'bottom', theme: 'ink', variante: 3, headline: 'Com barra de destaque acima.' },
  { layout: 'cta', theme: 'ink', variante: 0, headline: 'O convite de sempre', url: 'exemplo.com.br/link' },
  { layout: 'cta', theme: 'ink', variante: 1, headline: 'Convite centralizado', url: 'exemplo.com.br/link' },
  { layout: 'cta', theme: 'ink', variante: 2, headline: 'URL em botão', url: 'exemplo.com.br/link' },
  { layout: 'cta', theme: 'ink', variante: 3, headline: 'Convite no topo', url: 'exemplo.com.br/link' },
  { layout: 'photo', theme: 'ink', variante: 0, photoDataUri: FOTO_CENA_TESTE, headline: 'Legenda dentro do <em>frame</em>' },
  {
    layout: 'photo',
    theme: 'ink',
    variante: 1,
  ...
  // Interativo (layout novo, tratamento mínimo/funcional — a passada de
  // design final vem na rodada de "layouts aprovados"): pergunta + 2 opções
  // + nota de espaço reservado pra enquete nativa.
  {
    layout: 'enquete',
    theme: 'ink',
    headline: 'Você também demora mais escolhendo o sabor do que comendo a pizza?',
    items: ['É uma reunião 😂', 'Já temos o favorito'],
  },
  // Prova Social (capa `full:false`, contida — o print precisa continuar
  // legível, diferente do texto-sobre-foto full-bleed dos demais tipos).
  // `headline` "Feedback" é sempre travado no código, nunca pedido/aceito da
  // IA (ver `gerarRascunhoComIA`).
  {
    layout: 'photo',
    theme: 'ink',
    full: false,
    headline: 'Feedback',
    photoDataUri: FOTO_CENA_TESTE,
    hint: 'Print real recortado da pasta "Prova Social" da Galeria.',
  },
  // Layouts tipográficos com foto de fundo (achado real do usuário: fundo
  // liso devia virar exceção, não regra) — mesma composição em todos,
  // ignorando o sistema de variantes de propósito (só o v0 de cada layout).
  { layout: 'cover', theme: 'ink', logoTop: true, headline: 'Cover ganha foto de fundo agora', hint: 'Hint continua legível por cima', photoDataUri: FOTO_CENA_TESTE },
  { layout: 'word', theme: 'ink', headline: 'Word também <em>muda</em>.', hint: 'Hint claro sobre a foto', photoDataUri: FOTO_CENA_TESTE },
  { layout: 'bottom', theme: 'ink', headline: 'Bottom com foto de fundo, ancorado embaixo', photoDataUri: FOTO_CENA_TESTE },
  { layout: 'split', theme: 'ink', title: 'Split sobre foto', text: 'O texto muted vira claro pra continuar legível aqui', photoDataUri: FOTO_CENA_TESTE },
  { layout: 'item', theme: 'ink', title: 'Item sobre foto', text: 'Mesma lógica do split, texto claro sobre o scrim', photoDataUri: FOTO_CENA_TESTE },
  { layout: 'list', theme: 'ink', headline: 'Lista sobre foto de fundo', items: ['Primeiro item', 'Segundo item', 'Terceiro item'], photoDataUri: FOTO_CENA_TESTE },
  { layout: 'cta', theme: 'ink', headline: 'Chama a gente e vê funcionando', url: '(48) 99805-4161', photoDataUri: FOTO_CENA_TESTE },
]
